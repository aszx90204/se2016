...
$sql3 = "select nowPrice from rowmaterial where userID = '$userID' and rowMaterialName = '$productName'";//現在元瞭價格
...
$storeNumber=$storerow['count(*)'];
$money = (int)(($summoney - ($nowPrice*$orderNumber))/$storeNumber);
